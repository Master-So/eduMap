...
export const generateTest = async (req, res) => {
  try {
    ...
    const test = await Test.create({ title: `${grade} curriculum quiz`, grade, board: grade, subject: subjectList[0], subjects: subjectList, topics: chapterList, chapters: chapterList, questions, createdBy: req.user._id });
